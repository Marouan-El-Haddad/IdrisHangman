...
(define Hangman-removeElem (lambda (arg-1 arg-2 arg-3 arg-4) (if (null? arg-3) (cond ((equal? arg-1 0) (let ((e-4 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-11 (- arg-4 1))) (PreludeC-45Uninhabited-absurd (lambda (eta-0) (DataC-45VectC-45Elem-u--uninhabited_Uninhabited_C-40C-40ElemC-32C-36xC-41C-32NilC-41 eta-0)) e-11))))))(else (let ((e-0 (- arg-1 1))) (let ((e-14 (car arg-3))) (let ((e-15 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-21 (- arg-4 1))) (cons e-14 (Hangman-removeElem e-0 arg-2 e-15 e-21)))))))))) (let ((e-25 (cdr arg-3))) (cond ((equal? arg-4 0) e-25)(else (cond ((equal? arg-1 0) (let ((e-4 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-11 (- arg-4 1))) (PreludeC-45Uninhabited-absurd (lambda (eta-0) (DataC-45VectC-45Elem-u--uninhabited_Uninhabited_C-40C-40ElemC-32C-36xC-41C-32NilC-41 eta-0)) e-11))))))(else (let ((e-0 (- arg-1 1))) (let ((e-14 (car arg-3))) (let ((e-15 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-21 (- arg-4 1))) (cons e-14 (Hangman-removeElem e-0 arg-2 e-15 e-21))))))))))))))))
(define Hangman-readGuess(blodwen-lazy (lambda () (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStr (csegen-13) "Guess: ") (lambda () (PrimIO-io_bind (PreludeC-45IO-getLine (csegen-13)) (lambda (u--x) (let ((sc0 (Hangman-isValidString (DataC-45String-toUpper u--x)))) (case (vector-ref sc0 0) ((0) (let ((e-1 (vector-ref sc0 1))) (lambda (eta-0) (cons (PreludeC-45Types-fastUnpack (DataC-45String-toUpper u--x)) e-1)))) (else (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) "Invalid guess") (lambda () (Hangman-readGuess)))))))))))))
(define Hangman-processGuess (lambda (arg-1 arg-2 arg-3) (let ((e-2 (car arg-3))) (let ((e-3 (cdr arg-3))) (let ((sc1 (DataC-45VectC-45Elem-isElem (lambda (eta-0) (lambda (eta-1) (((DecidableC-45Equality-u--decEq_DecEq_Char) eta-0) eta-1))) arg-2 e-3))) (case (vector-ref sc1 0) ((0) (let ((e-1 (vector-ref sc1 1))) (vector 1 (cons e-2 (Hangman-removeElem arg-1 arg-2 e-3 e-1))))) (else (vector 0 (cons e-2 e-3)))))))))
(define Hangman-main(blodwen-lazy (lambda () (PrimIO-io_bind (Hangman-game 4 2 (cons "ITU" (cons #\I (cons #\T (cons #\U '()))))) (lambda (u--result) (case (vector-ref u--result 0) ((0) (let ((e-1 (vector-ref u--result 1))) (let ((e-6 (car e-1))) (PreludeC-45IO-putStrLn (csegen-13) (string-append ((csegen-23) "You lose. The word was ") e-6))))) (else (PreludeC-45IO-putStrLn (csegen-13) ((csegen-23) "You win! The word was ITU")))))))))
(define Hangman-isValidTwo (lambda (arg-0) (blodwen-error-quit "No clauses")))
(define Hangman-isValidString (lambda (arg-0) (Hangman-isValidInput (PreludeC-45Types-fastUnpack arg-0))))
(define Hangman-isValidNil (lambda (arg-0) (blodwen-error-quit "No clauses")))
(define Hangman-isValidInput (lambda (arg-0) (if (null? arg-0) (vector 1 (lambda (eta-0) (Hangman-isValidNil eta-0))) (let ((e-2 (car arg-0))) (let ((e-3 (cdr arg-0))) (if (null? e-3) (vector 0 e-2) (vector 1 (lambda (eta-0) (Hangman-isValidTwo eta-0)))))))))
(define Hangman-game (lambda (arg-0 arg-1 arg-2) (PrimIO-io_bind (Hangman-readGuess) (lambda (_-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (let ((e-5 (car e-2))) (let ((e-6 (cdr e-2))) (let ((eff-0 e-3)) (let ((sc3 (Hangman-processGuess arg-1 e-5 arg-2))) (case (vector-ref sc3 0) ((0) (let ((e-4 (vector-ref sc3 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) (string-append "Wrong! " (string-append (PreludeC-45Show-u--show_Show_Nat arg-0) " guesses remaining"))) (cond ((equal? arg-0 0) (lambda () (lambda (eta-0) (vector 0 e-4))))(else (let ((e-0 (- arg-0 1))) (lambda () (Hangman-game e-0 arg-1 e-4)))))))) (else (let ((e-7 (vector-ref sc3 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) "Right!") (cond ((equal? arg-1 0) (lambda () (lambda (eta-0) (vector 1 e-7))))(else (let ((e-0 (- arg-1 1))) (lambda () (Hangman-game arg-0 e-0 e-7)))))))))))))))))))
...
(PrimIO-unsafePerformIO (Hangman-main))  (collect 4)
