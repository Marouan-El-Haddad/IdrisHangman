...
;; @generated by Idris 0.5.1-f03f184af, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define csegen-13(blodwen-lazy (lambda () (cons (csegen-12) (lambda (u--a) (lambda (arg-11999) arg-11999))))))
(define csegen-23(blodwen-lazy (lambda () (let ((eff-0 (lambda (eta-0) eta-0))) (lambda (arg-0) (eff-0 arg-0))))))
...
(define Exercise-removeElem (lambda (arg-1 arg-2 arg-3 arg-4) (if (null? arg-3) (cond ((equal? arg-1 0) (let ((e-4 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-11 (- arg-4 1))) (PreludeC-45Uninhabited-absurd (lambda (eta-0) (DataC-45VectC-45Elem-u--uninhabited_Uninhabited_C-40C-40ElemC-32C-36xC-41C-32NilC-41 eta-0)) e-11))))))(else (let ((e-0 (- arg-1 1))) (let ((e-14 (car arg-3))) (let ((e-15 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-21 (- arg-4 1))) (cons e-14 (Exercise-removeElem e-0 arg-2 e-15 e-21)))))))))) (let ((e-25 (cdr arg-3))) (cond ((equal? arg-4 0) e-25)(else (cond ((equal? arg-1 0) (let ((e-4 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-11 (- arg-4 1))) (PreludeC-45Uninhabited-absurd (lambda (eta-0) (DataC-45VectC-45Elem-u--uninhabited_Uninhabited_C-40C-40ElemC-32C-36xC-41C-32NilC-41 eta-0)) e-11))))))(else (let ((e-0 (- arg-1 1))) (let ((e-14 (car arg-3))) (let ((e-15 (cdr arg-3))) (cond ((equal? arg-4 0) (blodwen-error-quit "Nat case not covered"))(else (let ((e-21 (- arg-4 1))) (cons e-14 (Exercise-removeElem e-0 arg-2 e-15 e-21))))))))))))))))
(define Exercise-readGuess(blodwen-lazy (lambda () (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStr (csegen-13) "Guess: ") (lambda () (PrimIO-io_bind (PreludeC-45IO-getLine (csegen-13)) (lambda (u--x) (let ((sc0 (Exercise-isValidString (DataC-45String-toUpper u--x)))) (case (vector-ref sc0 0) ((0) (let ((e-1 (vector-ref sc0 1))) (lambda (eta-0) (cons (PreludeC-45Types-fastUnpack (DataC-45String-toUpper u--x)) e-1)))) (else (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) "Invalid guess") (lambda () (Exercise-readGuess)))))))))))))
(define Exercise-processGuess (lambda (arg-1 arg-2 arg-3) (let ((e-2 (car arg-3))) (let ((e-3 (cdr arg-3))) (let ((sc1 (DataC-45VectC-45Elem-isElem (lambda (eta-0) (lambda (eta-1) (((DecidableC-45Equality-u--decEq_DecEq_Char) eta-0) eta-1))) arg-2 e-3))) (case (vector-ref sc1 0) ((0) (let ((e-1 (vector-ref sc1 1))) (vector 1 (cons e-2 (Exercise-removeElem arg-1 arg-2 e-3 e-1))))) (else (vector 0 (cons e-2 e-3)))))))))
(define Exercise-main(blodwen-lazy (lambda () (PrimIO-io_bind (Exercise-game 4 2 (cons "ITU" (cons #\I (cons #\T (cons #\U '()))))) (lambda (u--result) (case (vector-ref u--result 0) ((0) (let ((e-1 (vector-ref u--result 1))) (let ((e-6 (car e-1))) (PreludeC-45IO-putStrLn (csegen-13) (string-append ((csegen-23) "You lose. The word was ") e-6))))) (else (PreludeC-45IO-putStrLn (csegen-13) ((csegen-23) "You win! The word was ITU")))))))))
(define Exercise-isValidTwo (lambda (arg-0) (blodwen-error-quit "No clauses")))
(define Exercise-isValidString (lambda (arg-0) (Exercise-isValidInput (PreludeC-45Types-fastUnpack arg-0))))
(define Exercise-isValidNil (lambda (arg-0) (blodwen-error-quit "No clauses")))
(define Exercise-isValidInput (lambda (arg-0) (if (null? arg-0) (vector 1 (lambda (eta-0) (Exercise-isValidNil eta-0))) (let ((e-2 (car arg-0))) (let ((e-3 (cdr arg-0))) (if (null? e-3) (vector 0 e-2) (vector 1 (lambda (eta-0) (Exercise-isValidTwo eta-0)))))))))
(define Exercise-game (lambda (arg-0 arg-1 arg-2) (PrimIO-io_bind (Exercise-readGuess) (lambda (_-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (let ((e-5 (car e-2))) (let ((e-6 (cdr e-2))) (let ((eff-0 e-3)) (let ((sc3 (Exercise-processGuess arg-1 e-5 arg-2))) (case (vector-ref sc3 0) ((0) (let ((e-4 (vector-ref sc3 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) (string-append "Wrong! " (string-append (PreludeC-45Show-u--show_Show_Nat arg-0) " guesses remaining"))) (cond ((equal? arg-0 0) (lambda () (lambda (eta-0) (vector 0 e-4))))(else (let ((e-0 (- arg-0 1))) (lambda () (Exercise-game e-0 arg-1 e-4)))))))) (else (let ((e-7 (vector-ref sc3 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) "Right!") (cond ((equal? arg-1 0) (lambda () (lambda (eta-0) (vector 1 e-7))))(else (let ((e-0 (- arg-1 1))) (lambda () (Exercise-game arg-0 e-0 e-7)))))))))))))))))))
(define DataC-45VectC-45Elem-with--withC-32blockC-32inC-32isElem-3604 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6 arg-7 arg-8) (case (vector-ref arg-5 0) ((0) (let ((e-1 (vector-ref arg-5 1))) (vector 0 (+ e-1 1)))) (else (let ((e-3 (vector-ref arg-5 1))) (vector 1 (lambda (eta-0) (DataC-45VectC-45Elem-neitherHereNorThere arg-8 e-3 eta-0))))))))
(define DataC-45VectC-45Elem-with--isElem-3559 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6 arg-7) (case (vector-ref arg-5 0) ((0) (vector 0 0)) (else (let ((e-3 (vector-ref arg-5 1))) (DataC-45VectC-45Elem-with--withC-32blockC-32inC-32isElem-3604 'erased arg-1 'erased arg-3 arg-6 (DataC-45VectC-45Elem-isElem arg-1 arg-3 arg-6) 'erased arg-4 e-3))))))
...
(define DataC-45VectC-45Elem-isElem (lambda (arg-2 arg-3 arg-4) (if (null? arg-4) (vector 1 (let ((eff-0 (lambda (arg-528) (DataC-45VectC-45Elem-u--uninhabited_Uninhabited_C-40C-40ElemC-32C-36xC-41C-32NilC-41 arg-528)))) (lambda (arg-0) (eff-0 arg-0)))) (let ((e-3 (car arg-4))) (let ((e-4 (cdr arg-4))) (DataC-45VectC-45Elem-with--isElem-3559 'erased arg-2 'erased arg-3 e-3 (((let ((eff-0 arg-2)) (lambda (arg-0) (lambda (arg-1) ((eff-0 arg-0) arg-1)))) arg-3) e-3) e-4 'erased))))))
(define DecidableC-45Equality-n--5259-4214-u--primitiveNotEq (lambda (arg-1 arg-2 arg-3 arg-7) (vector 0 )))
(define DecidableC-45Equality-n--5259-4213-u--primitiveEq (lambda (arg-1 arg-2 arg-3) (vector 0 )))
(define DecidableC-45Equality-u--decEq_DecEq_FromEqC-36a (lambda (arg-1 arg-2 arg-3) (let ((sc0 (let ((e-1 (car arg-1))) ((e-1 arg-2) arg-3)))) (cond ((equal? sc0 1) (vector 0 (DecidableC-45Equality-n--5259-4213-u--primitiveEq arg-1 arg-2 arg-3))) (else (vector 1 (lambda (eta-0) (DecidableC-45Equality-n--5259-4214-u--primitiveNotEq arg-1 arg-2 arg-3 eta-0))))))))
(define DecidableC-45Equality-u--decEq_DecEq_Char(blodwen-lazy (lambda () (let ((eff-0 (lambda (u--x1) (lambda (u--x2) (DecidableC-45Equality-u--decEq_DecEq_FromEqC-36a (cons (lambda (arg-528) (lambda (arg-531) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-528 arg-531))) (lambda (arg-538) (lambda (arg-541) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-538 arg-541)))) u--x1 u--x2))))) (lambda (arg-0) (lambda (arg-1) ((eff-0 arg-0) arg-1)))))))
...
(define PreludeC-45Types-u--map_Functor_List (lambda (arg-2 arg-3) (if (null? arg-3) '() (let ((e-2 (car arg-3))) (let ((e-3 (cdr arg-3))) (cons (arg-2 e-2) (((let ((eff-0 (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8737) (PreludeC-45Types-u--map_Functor_List u--func arg-8737))))))) (lambda (arg-0) (lambda (arg-1) ((((eff-0 'erased) 'erased) arg-0) arg-1)))) arg-2) e-3)))))))
...
(define DataC-45String-toUpper (lambda (arg-0) (PreludeC-45Types-fastPack (((let ((eff-0 (lambda (eta-0) (lambda (eta-1) (lambda (eta-2) (lambda (eta-3) (PreludeC-45Types-u--map_Functor_List eta-2 eta-3))))))) (lambda (arg-1) (lambda (arg-2) ((((eff-0 'erased) 'erased) arg-1) arg-2)))) (lambda (eta-0) (PreludeC-45Types-toUpper eta-0))) (PreludeC-45Types-fastUnpack arg-0)))))
(load-shared-object "libidris2_support.so")
(collect-request-handler (lambda () (collect) (blodwen-run-finalisers)))
(PrimIO-unsafePerformIO (Exercise-main))  (collect 4)
